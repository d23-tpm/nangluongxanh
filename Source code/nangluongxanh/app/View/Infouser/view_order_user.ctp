	...
	<div class="users manage-status form-admin form">
      ...
      <div class="table-responsive">  
		<table class="table table-bordered table-hover">
            ...
            <?php endforeach; ?>
            <tr class="success">
					<td colspan=4 style="text-align: right;color: #000;font-family: helvetica;font-size: 15px;">Tổng Tiền:</td>
					<td style="color: #f1a827;font-size: 16px;text-shadow: none !important;"><?php echo number_format($total);?> VNĐ
					</td>
				</tr>
            <?php unset($items); ?>
        </table>
        <?php echo $this->Html->link(__('Quay lại'), array('controller'=>'infouser','action'=>'orderuser'), array('class' => 'back-product btn btn-primary')); ?>
        </div>
	</div>
